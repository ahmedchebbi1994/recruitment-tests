...
final class DetailsBookView: ReusableUIView {
    
    // MARK: - Property
    static let identifier = "detailsBook"
    ...
    override func configUI() {
        ...
        tableView.register(UITableViewCell.self, forCellReuseIdentifier: DetailsBookView.identifier)
    }
